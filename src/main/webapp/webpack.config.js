...
module.exports = {
    ...
    entry: {
        ...
        adminBoard: '/js/admin/board/adminBoard.js',
        adminPost: '/js/admin/board/adminPost.js',
        adminPostWrite: '/js/admin/board/adminPostWrite.js',
        adminPostEditView: '/js/admin/board/adminPostEditView.js',
        adminPostEdit: '/js/admin/board/adminPostEdit.js',
        adminFaq: '/js/admin/board/adminFaq.js',
        adminFaqWrite: '/js/admin/board/adminFaqWrite.js',
        adminFaqEdit: '/js/admin/board/adminFaqEdit.js',
        adminQna: '/js/admin/board/adminQna.js',
        adminQnaEdit: '/js/admin/board/adminQnaEdit.js',
        adminGis: '/js/admin/pilot/adminGis.js',
        adminEditor: '/js/admin/pilot/adminEditor.js',
    },
    output: {
